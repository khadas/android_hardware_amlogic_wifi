...
void wpa_config_free_ssid(struct wpa_ssid *ssid)
{
	...
	os_free(ssid->bgscan);
	os_free(ssid->p2p_client_list);
	os_free(ssid->wpa_psk_file_path);
...
static const struct global_parse_data global_fields[] = {
	...
	{ INT_RANGE(p2p_scan_band, 0, 2), 0 },
	{ INT_RANGE(p2p_neg_conf_ack, 0, 1), 0 },
	{ INT(p2p_expire_age), 0 },
	{ INT(p2p_expire_poll), 0 },
	{ STR(wpa_psk_file), 0 },
#endif /* CONFIG_P2P */
