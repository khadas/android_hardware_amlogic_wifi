...
struct wpa_global {
	...
	char *wpa_psk_file_path;

#ifdef CONFIG_WIFI_DISPLAY
	int wifi_display;
	int wifi_display_attach;
	int wifi_display_diff_p2p_attr;
#define MAX_WFD_SUBELEMS 10
	...
	int	widi_dev_type[8];
	u32 widi_vendor_id; /* application must config vendor ID before receiving L2SD/L2TA */
...
#define WILDCARD_SSID_SCAN ((struct wpa_ssid *) 1)
	...
	enum wpa_states prev_wpa_state;
