...
#define DEFAULT_P2P_PEER_EXPIRATION_AGE 300
#define DEFAULT_P2P_PEER_EXPIRATION_INTERVAL (DEFAULT_P2P_PEER_EXPIRATION_AGE / 2)
...
#define MAX_SEC_DEVICE_TYPES 5
	...
	/**
	 * p2p_listen_reg_class - P2P listen channel regulatory class
	 * This value is defined at Table J-4 in P802.11REVmb as below.
	 * 81 : channels 1..13
	 * Ex: p2p_listen_reg_class=81
	 */
	int p2p_listen_reg_class;

	/**
	 * p2p_listen_channel - P2P listen channel
	 * The channel is chosen from the set of Social Channels (1, 6, and 11).
	 * Which is used by a P2P Device to be discoverable.
	 * Ex: p2p_listen_channel=1
	 */
	int p2p_listen_channel;

	/**
	 * p2p_oper_reg_class - P2P operating channel regulatory class
	 * This value is defined at Table J-4 in P802.11REVmb as below.
	 * 81 : channels 1..13
	 * 115: channels 36,40,44,48
	 * 124: channels 149,153,157,161
	 * Ex: p2p_listen_reg_class=81
	 */
	int p2p_oper_reg_class;

	/**
	 * p2p_oper_channel - P2P operating channel
	 * The channel is chosen from the 802.11 channels.
	 * It can be the channel of 2.4GHz or 5Ghz band. We support below channels currently.
	 * 2.4GHz band: channels 1..13
	 * 5.GHz band : channels 36,40,44,48,149,153,157,161.
	 * Ex: p2p_oper_channel=1
	 */
	int p2p_oper_channel;

	/**
	 * p2p_go_intent - P2P group owner intent value
	 * This intent values is used for GO Negotiation to measure which P2P device will be Group Owner.
	 * It is equal or less than 15. If the P2P device must be the Group Owner, it shall be set to 15.
	 * Ex: p2p_go_intent=10
	 */
	int p2p_go_intent;

	/**
	 * p2p_ssid_postfix - P2P SSID postfix
	 */
	char *p2p_ssid_postfix;

	/**
	 * persistent_reconnect - Support for reconnection of a persistent P2P group
	 * It is used to invoke persistent P2P group by invitation process automatically.
	 * Ex: persistent_reconnect=1
	 */
	int persistent_reconnect;

	/**
	 * p2p_intra_bss - Support for intra BSS communication
	 * The P2P group owner can provide a data distribution service between all connected clients in the P2P Group.
	 * Ex: p2p_intra_bss=1
	 */
	int p2p_intra_bss;
	...
	/**
	 * p2p_max_clients - Maximum p2p clients which GO could accept
	 * This is used to restrict the number of P2P clients that can join the group.
	 * Ex: p2p_max_clients=5
	 */
	unsigned int p2p_max_clients;

	/**
	 * p2p_scan_band - Skip 2GHz or 5GHz band scan
	...
	/**
	 * wpa_psk_file - Per-STA PSK template for P2P-GO
	 * This is used to specify the file path and act as prefix.
	 */
	char *wpa_psk_file;
...
#define MAX_WPS_VENDOR_EXT 10
	 ...
	 * p2p_neg_conf_ack
	 *
	 * Check the TX status of Negotiation Confirm frame to let negotiation process 
	 * more robust. 
	 */
