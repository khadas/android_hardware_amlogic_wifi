...
#define WPS_VENDOR_ID_INTEL 0x000157
...
struct wpabuf * wps_build_assoc_req_ie(int pbc, enum wps_request_type req_type);
...
struct wps_context {
	...
	/**
	 * psk_per_sta - Set Per-STA-PSK
	 *
	 * This optional value is used to set Per-STA-PSK.
	 */
	int psk_per_sta;
