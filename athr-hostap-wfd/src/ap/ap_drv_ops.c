...
int hostapd_drv_sta_kick(struct hostapd_data *hapd, const u8 *addr)
{
	if (hapd->driver == NULL || hapd->driver->kick_sta == NULL)
		return 0;
	return hapd->driver->kick_sta(hapd->drv_priv, addr);
}
